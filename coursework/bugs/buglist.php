...
if(isset($_POST["submit"]))
{
 ...
 //echo $insertbday;
   ...
   // $bugID = $row['userID'];
    ...
    $query = mysqli_query($db, "INSERT INTO bugs (`bugID`, `title`, `desc`,`userID`,'postDate','fixDate') VALUES ( default,'$bugtitle', '$bugdesc','$login_user',DEFAULT ,DEFAULT )")or die(mysqli_error($db));
